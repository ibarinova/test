...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:import href="plugin:org.dita.post:xsl/dita2postImpl.xsl"/>
  <xsl:import href="plugin:org.dita.post:xsl/map2postImpl.xsl"/>  
  
  <dita:extension id="dita.xsl.post.cover" 
