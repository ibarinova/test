...
<xsl:param name="OUTEXT" select="'.html'"/>
  ...
  <xsl:template match="*[contains(@class, ' map/topicref ')]
    ...
    <xsl:choose>
	<!--Do not process copyright topic for TOC  -->
      <xsl:when test="normalize-space($title) !='' and not(contains(lower-case($title), 'copyright'))">
        <topic>
			<xsl:choose>
  ...
  <xsl:template match="*" mode="get-title">
    <xsl:choose>
      <!-- If navtitle is specified -->
      <xsl:when test="*[contains(@class, ' map/topicmeta ')]/*[contains(@class, ' topic/title ')]">
        <xsl:apply-templates select="*[contains(@class, ' map/topicmeta ')]/*[contains(@class, ' topic/title ')]"
