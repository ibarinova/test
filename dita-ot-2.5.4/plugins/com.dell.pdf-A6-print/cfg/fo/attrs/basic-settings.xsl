...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="page-width">105mm</xsl:variable>
    <xsl:variable name="page-height">148mm</xsl:variable>

    <xsl:variable name="page-margin-inside" select="'15mm'"/>
    <xsl:variable name="page-margin-outside" select="'12mm'"/>
    <xsl:variable name="page-margin-top" select="'0.45in'"/>
    <xsl:variable name="page-margin-top_toc" select="'0.8in'"/>
    <xsl:variable name="page-margin-bottom" select="'0.65in'"/>
    <xsl:variable name="page-margin-bottom_toc" select="'1in'"/>

    <xsl:variable name="side-col-width">0pt</xsl:variable>

    <xsl:variable name="default-font-size">6pt</xsl:variable>
    <xsl:variable name="default-line-height">7pt</xsl:variable>
    ...
    <xsl:variable name="generate-toc" select="if($multilingual) then(false()) else(true())" as="xs:boolean"/>
