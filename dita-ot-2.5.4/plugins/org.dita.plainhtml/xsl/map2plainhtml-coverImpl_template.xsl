...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:import href="plugin:org.dita.plainhtml:xsl/dita2plainhtmlImpl.xsl"/>
  <xsl:import href="plugin:org.dita.plainhtml:xsl/map2plainhtmlImpl.xsl"/>  
  
  <dita:extension id="dita.xsl.plainhtml.cover" 
...
<!--      <xsl:apply-templates select="*[contains(@class, ' ditaot-d/ditaval-startprop ')]/@outputclass" mode="add-ditaval-style"/>
  ...
  <!-- removed h1 as per edell request -->
