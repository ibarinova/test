...
function RunAnt_DellQA
{
	...
	Write-Host "Running RunAnt_DellQA..."
...
function RunAnt_DellEMCWEB
{
	...
	$command = "dita.bat -format=""$DITAOTTransType"" -i=""$MapFileLocation"" -output=""$OutputFolder"" -temp=""$TempFolder"" -Dargs.draft=""$DraftComments"" -Dclean.temp=no -Dvalidate=$Dvalidate -Dargs.language=""$Languages"" --verbose -l ""$LogFileLocation"""
	Write-Host "Running command ""$command"""
	& dita.bat "-format=$DITAOTTransType" "-i=""$MapFileLocation""" "-output=""$OutputFolder""" "-temp=""$TempFolder""" "-Dclean.temp=no" "-Dvalidate=false" "-v" "-l" "$LogFileLocation"
}
function RunAnt_DellSUPPORTHTML
{
	param
	(
		[String]$MapFileLocation,
	...
	Write-Host "Running RunAnt_DellSUPPORTHTML..."
...
function RunAnt_DellDistribution
{
	param
	(
		[String]$MapFileLocation,
	...
	Write-Host "Running RunAnt_DellDistribution..."

	$command = "ant.bat -Dtranstype=""$DITAOTTransType"" -Dargs.input=""$MapFileLocation"" -Doutput.dir=""$OutputFolder"" -Ddita.temp.dir=""$TempFolder"" -Dargs.draft=""$DraftComments"" -Dclean.temp=no -Dvalidate=$Dvalidate -Dargs.language=""$Languages"" -logfile ""$LogFileLocation"""
	Write-Host "Running command ""$command"""
	& ant.bat "-Dtranstype=$DITAOTTransType" "-Dargs.input=""$MapFileLocation""" "-Doutput.dir=""$OutputFolder""" "-Ddita.temp.dir=""$TempFolder""" "-Dclean.temp=no" "-Dvalidate=false" -logfile "$LogFileLocation"
}
function RunAnt_DellPubdelete
{
	param
	(
		[String]$MapFileLocation,
	...
	Write-Host "Running RunAnt_DellPubdelete..."

	$command = "ant.bat -Dtranstype=""$DITAOTTransType"" -Dargs.input=""$MapFileLocation"" -Doutput.dir=""$OutputFolder"" -Ddita.temp.dir=""$TempFolder"" -Dargs.draft=""$DraftComments"" -Dclean.temp=no -Dvalidate=$Dvalidate -Dargs.language=""$Languages"" -logfile ""$LogFileLocation"""
	Write-Host "Running command ""$command"""
	& ant.bat "-Dtranstype=$DITAOTTransType" "-Dargs.input=""$MapFileLocation""" "-Doutput.dir=""$OutputFolder""" "-Ddita.temp.dir=""$TempFolder""" "-Dclean.temp=no" "-Dvalidate=false" -logfile "$LogFileLocation"
}
function RunAnt_Dellpost
{
	param
	(
		[String]$MapFileLocation,
	...
	Write-Host "Running RunAnt_Dellpost..."
