...
function closePublicationToc(sideToc, pageToc) {
    ...
    console.log('----------------------------------');
    console.log('sideToc = ' + sideToc.length);
    console.log('pageToc = ' + pageToc.length);
    if(sideToc.length) {
        var topicContentColumn = 7;
        ...
        var topicContentParent = $('#wh_topic_body');
        ...
        if(sideToc.hasClass("d-md-block") && sideToc.is(':visible')) {
            ...
            console.log(topicContentParent);
            if (topicContentParent !== undefined) {
                console.log('1');

                topicContentParent.removeClass(`col-lg-${topicContentColumn} col-md-9`);
                topicContentParent.addClass(`col-lg-${topicContentColumn + publicationTocColumns + 2} col-md-12`);
            ...
            if (topicContentParent !== undefined) {
                topicContentParent.removeClass(`col-lg-${topicContentColumn + publicationTocColumns + 2} col-md-12`);
