...
if ($DITAOTTransType -eq "dell-webhelp-responsive" -or $DITAOTTransType -eq "dellemc-webhelp-responsive.draft" -or $DITAOTTransType -eq "dellemc-webhelp-responsive.rsa")
{
...
if ($DITAOTTransType -eq "html5-webhelp-emc-draft" -or $DITAOTTransType -eq "html5-webhelp-rsa-draft" -or $DITAOTTransType -eq "webhelp-draft" -or $DITAOTTransType -eq "webhelp-mobile-draft" -or $DITAOTTransType -eq "webhelp-mobile-rsa-draft" -or $DITAOTTransType -eq "webhelp-rsa-draft" -or $DITAOTTransType -eq "webhelp-single-draft" -or $DITAOTTransType -eq "xhtml-emc-draft" -or $DITAOTTransType -eq "xhtml-mozy-draft" -or $DITAOTTransType -eq "webhelp-responsive.rsa.draft" -or $DITAOTTransType -eq "dellemc-webhelp-responsive.draft")
{
	$DraftComments = "yes"
    RunAnt_DellEMCWEB $MapFileLocation $OutputFolder $TempFolder $LogFileLocation $DITAOTTransType $DraftComments $Compare $CombinedLanguages $PublishPostProcessContextFileLocation
}

if ($DITAOTTransType -eq "atl" -or $DITAOTTransType -eq "html5-responsive" -or $DITAOTTransType -eq "emc-visualizer")
{
...
if ($DITAOTTransType -eq "pdf-emc" -or $DITAOTTransType -eq "emcpdf" -or $DITAOTTransType -eq "cpsdpdf")
{
...
if ($DITAOTTransType -eq "pdf-insert-emc")
{
...
if ($DITAOTTransType -eq "word-emc" -or $DITAOTTransType -eq "word-solgen")
{
	RunAnt_pdfemc $MapFileLocation $OutputFolder $TempFolder $LogFileLocation $DITAOTTransType $DraftComments $Compare $CombinedLanguages $PublishPostProcessContextFileLocation
