...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="__toc__indent">
	...
	<!-- Balaji Mani 16-July-2013: one more level extended for part -->
      ...
      <xsl:variable name="level" >
        <xsl:choose>
		<!-- Balaji Mani 1-Apr-2013: Added to disply the TOC in same level -->
      ...
      <!--Suite/EMC   SOW5  07-Feb-2012   updated from 2 to 2.375 - ck-->
