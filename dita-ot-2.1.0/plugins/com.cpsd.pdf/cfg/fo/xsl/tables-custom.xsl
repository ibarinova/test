            ...
            <fo:table table-omit-footer-at-break="true">
              ...
              <xsl:variable name="column-width">
                <xsl:choose>
                  ...
                  <xsl:otherwise>
					<!-- Dimitri: After adding the ol and ul indent, increase table indent inside lists and steps. -->
                  ...
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <xsl:choose>
						...
						<!-- Dimitri: Fix table width inside steps and lists. -->
                        <!--xsl:when test="$parent='substep'"/-->
						<!--xsl:when test="$parent='substep' or ancestor::step or ancestor::ol or ancestor::ul"/-->
						<xsl:when test="ancestor::step or ancestor::li"/>
                        <xsl:otherwise>
