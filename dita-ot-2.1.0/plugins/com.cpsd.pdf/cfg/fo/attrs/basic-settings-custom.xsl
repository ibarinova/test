...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Dimitri: Decrease index page margins. -->
    <!--xsl:variable name="page-margin-outside-index">0.625in</xsl:variable-->
	<xsl:variable name="page-margin-outside-index">0.5in</xsl:variable>
	...
	<xsl:variable name="page-margin-inside-index">0.5</xsl:variable>
    ...
    <xsl:variable name="side-col-1">0in</xsl:variable>
    <xsl:variable name="side-col-2">0in</xsl:variable>
    <xsl:variable name="side-col-width">0in</xsl:variable>
	<!-- Dimitri: Increase main page area, so that tables render in full page width. -->
    <!--xsl:variable name="main-col">5.268</xsl:variable-->
	<xsl:variable name="main-col">7.268</xsl:variable>
