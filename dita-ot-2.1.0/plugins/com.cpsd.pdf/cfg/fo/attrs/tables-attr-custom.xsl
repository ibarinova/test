...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0">
  ...
  <xsl:attribute-set name="table.title" use-attribute-sets="base-font common.title">
	...
	<!-- Dimitri: Render table titles italic and in blue color. -->
  ...
  <!-- Dimitri: Do not break table rows across pages. -->
  <!-- Dimitri: Do not use. Very long rows, exceeding one page in height, run over the bottom of a page. Instead, use the "tbody.row.entry__content" fix below. -->
