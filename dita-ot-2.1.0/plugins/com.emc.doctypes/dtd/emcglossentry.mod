...
PUBLIC "-//EMC//ELEMENTS DITA Glossary Entry//EN"
      Delivered as file "emcglossentry.mod"                        -->
...
<!-- 
	Revision History
	================     
	EMC      PDFGlossary    9-Jul-2013   Added customization(gloss-sort-as tag) for the Glossary
-->
...
<!ENTITY % gloss-sort-as  "gloss-sort-as"                            >
...
<!--                    LONG NAME: Glossary Sort As             -->
<!ENTITY % gloss-sort-as.content
                       "(%words.cnt;)*"
>
<!ENTITY % gloss-sort-as.attributes
             "keyref 
              ...
              %ishlinkxpath-general-default;"
>
<!ELEMENT gloss-sort-as    %gloss-sort-as.content;>
<!ATTLIST gloss-sort-as    %gloss-sort-as.attributes;>
...
<!ATTLIST gloss-sort-as   %global-atts;  class CDATA "- topic/data glossentry/gloss-sort-as ">
