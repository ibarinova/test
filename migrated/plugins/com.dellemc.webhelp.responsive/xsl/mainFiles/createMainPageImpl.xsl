...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="generate-redirect-script">
		<script type="text/javascript" src="./oxygen-webhelp/app/dell-topic-input-sanitizer.js"><!----></script>
		<script type="text/javascript" src="./oxygen-webhelp/app/dell-topic-loader.js"><!----></script>
		<xsl:result-document method="text" href="oxygen-webhelp/app/dell-topic-loader.js">
	...
	if (actualLocation.match(/[\w\.\-%]+\.htm(l)?%3F(topic|context)%3D([\w#\-]+)/gi) != null) {
		...
		if (linkSearchPosition !== -1) {
			...
			if (resourceId != null) {
				...
				Object.entries(EMCKickstart.webhelpMap).forEach(entry => {
